  ...
  createOrder: async (req, res) => {
    ...
    try {
      const body = {
        ...
        notification_url: `https://backend-c-r-production.up.railway.app/order/webhook?venta=${encodeURIComponent(venta)}&customerId=${customerId}&metodoPagoId=${metodoPagoId}`,
      };
